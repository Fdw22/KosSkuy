                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Kelompok</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createKelompok" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateKelompok" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewKelompok" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteKelompok" class="minimal"></td>
                      </tr>
                      ...
                      <tr>
                        <td>Cabang</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createCabang" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateCabang" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewCabang" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteCabang" class="minimal"></td>
                      </tr>
